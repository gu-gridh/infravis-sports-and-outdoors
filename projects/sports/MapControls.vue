    ...
    <div class="map-controls">
      ...
      <template v-if="store.commune && store.metric === 'index'">
        ...
        <div class="btn-group">
          ...
          <button
            v-for="time in store.travelTimes"
            :key="time"
            @click="setTime(time)"
      ...
      <template v-if="store.commune && store.metric === 'sustainability'">
        <div class="btn-group">
          ...
          <button
            v-for="day in dayTypes"
            :key="day.value"
            @click="setSustainabilityDay(day.value)"
        ...
        <div class="btn-group">
          ...
          <button
            v-for="type in activityTypes"
            :key="type.value"
            @click="setSustainabilityActivity(type.value)"
        ...
        <div class="btn-group">
          ...
          <button
            v-for="time in store.travelTimes"
            :key="time"
            @click="setSustainabilityTime(time)"
